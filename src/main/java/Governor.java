/**
 * Represents the Governor (Prime Minister) in the system.
 * This class extends User and sets the role to GOVERNOR.
 * 
...
public class Governor extends User {
    ...
    /**
     * Returns a string representation of the Governor.
