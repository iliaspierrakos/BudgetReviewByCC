...
/**
 * Represents a member of a Ministry in the system. This class extends User and adds
 * ministry-specific information.
 *
 * Each MinistryMember has a username, password, role (MINISTRYMEMBER), and is associated with a
 * specific ministry.
 */
...
public class MinistryMember extends User {
  ...
  /**
   * Returns a string representation of the MinistryMember. Includes username and ministry name.
   *
