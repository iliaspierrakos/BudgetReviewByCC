...
/**
 * Represents a Citizen in the system. This class extends User and sets the role to CITIZEN.
 *
 * <p>
...
public class Citizen extends User {
  ...
  /**
   * Returns a string representation of the Citizen. Includes only the username.
   *
