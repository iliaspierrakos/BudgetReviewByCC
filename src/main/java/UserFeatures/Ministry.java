...
/**
 * The {@code Ministry} class represents a government ministry
 * with a name and an assigned budget.
 *
 * <p>This class also provides utility methods for searching,
 * formatting, and displaying ministry budget information.</p>
 */
public class Ministry {
     ...
     */
    public static double budgetSearchByName(
            String searchingMinistry,
            Ministry[] ministriesArray) {

        Ministry m = findByName(searchingMinistry, ministriesArray);
        if (m == null) {
            throw new IllegalArgumentException(
                "Ministry not found: " + searchingMinistry
            );
        }
        return m.budget;
    }
     ...
     */
    public static Ministry findByName(
            String searchingMinistry,
            Ministry[] ministriesArray) {
        ...
        for (Ministry m : ministriesArray) {
            if (m == null) continue;
            if (m.ministryName != null &&
                m.ministryName.equalsIgnoreCase(searchingMinistry)) {
                return m;
            }
        }
        return null;
    ...
    /**
     * Formats a budget value using Greek/German-style formatting
     * (e.g. {@code 1.234.567,89}).
     *
