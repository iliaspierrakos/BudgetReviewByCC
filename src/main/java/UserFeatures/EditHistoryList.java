 ...
 *
 * <p>All balance and budget mutations are delegated to {@link Edit#applyEdit(Edit, boolean, boolean)}
 * to ensure consistent state transitions.</p>
 */
public class EditHistoryList {
     ...
     *
     * <p>This is not used for file-based proposals directly; proposals should be parsed
     * and applied via {@link Edit#parse(String)} and {@link Edit#applyEdit(Edit, boolean, boolean)}.</p>
     */
