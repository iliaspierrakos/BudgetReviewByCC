...
/**
 * The MinistryProgress class provides functionality to view the budget progress of a specific
 * ministry across all available years (2020-2026).
 */
public class MinistryProgress {

  /**
   * Displays the budget progress for a specific ministry across all available years. Shows the
   * ministry name, year, and budget in a formatted table.
   *
  ...
  /**
   * Interactive method that prompts the user to enter a ministry name and then displays its budget
   * progress.
   */
