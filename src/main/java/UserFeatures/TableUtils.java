...
/**
 * Utility class for creating formatted table outputs. Provides reusable methods for table
 * formatting used across View, Compare, and BulkEdit.
 */
public class TableUtils {

  /**
   * Appends a table row with aligned columns to the StringBuilder. First column is left-aligned (60
   * chars), remaining columns are right-aligned (20 chars each).
   *
  ...
  /**
   * Appends a separator line (decorative line of repeated characters). Used for creating visual
   * separation between sections of a table.
   *
   * @param sb The StringBuilder to append to
  ...
  /**
   * Appends a centered title. Uses right-alignment with calculated padding to achieve centering
   * effect.
   *
   * @param sb The StringBuilder to append to
  ...
  /**
   * Appends a table row with custom column widths. Used primarily in BulkEdit preview tables which
   * need wider columns.
   *
   * @param sb The StringBuilder to append to
