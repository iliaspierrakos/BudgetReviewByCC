 ...
 * DraftEditSession
 *
 * Centralized, shared in-memory session that manages minister draft budget edits.
...
public final class DraftEditSession {
    ...
    /**
     * Reset draft state from currently loaded "official" in-memory budgets.
     * startingBalance typically 0 (reallocation-only rule) or another chosen rule.
     *
